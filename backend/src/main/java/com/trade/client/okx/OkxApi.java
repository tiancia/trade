...
public class OkxApi {
    ...
    /**
     * Gets current positions for derivatives or margin instruments.
     */
    public OkxResponse<PositionResp> getPositions(PositionsReq req) {
        return okxClient.get(
                OkxEndpoints.ACCOUNT_POSITIONS,
                req,
                true,
                PositionResp.class
        );
