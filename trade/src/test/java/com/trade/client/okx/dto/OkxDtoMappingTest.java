...
class OkxDtoMappingTest {
    ...
    void mapsTickerResponse() throws Exception {
        ...
        OkxResponse<TickerResp> resp = read(json, TickerResp.class);
    ...
    void mapsOrderBookArrayLevels() throws Exception {
        ...
        OkxResponse<OrderBookResp> resp = read(json, OrderBookResp.class);
    ...
    void mapsCandleArrayRows() throws Exception {
        ...
        OkxResponse<CandleResp> resp = read(json, CandleResp.class);
    ...
    void mapsOrderActionResponse() throws Exception {
        ...
        OkxResponse<OrderActionResp> resp = read(json, OrderActionResp.class);
    ...
    @Test
    void mapsOrderActionBusinessFailureResponse() throws Exception {
        String json = """
                {
                  "code": "1",
        ...
        assertEquals("Operation failed.", resp.getMsg());
        assertNotNull(resp.getData());
        assertEquals("client-1", resp.getData().get(0).getClOrdId());
        assertEquals("51008", resp.getData().get(0).getSCode());
    }

    private <T> OkxResponse<T> read(String json, Class<T> dataClass) throws Exception {
